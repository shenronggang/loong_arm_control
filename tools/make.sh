...
if [ ${1:0:1} == 'x' ];then
    if [ ${1:1:1} == 's' ]; then
        ...
        cp ../nabo_output/libnabo_manipulation_x64.so ../../loong_sim/module/nabo_manipulation/
    else
        ...
        make -j6 install
        echo ==== 实机x64，复制.so到base ===
        cp ../nabo_output/libnabo_manipulation_x64.so ../../loong_base/module/nabo_manipulation/
    ...
    if [ ${1:1:1} == 's' ]; then
        ...
        cp ../nabo_output/libnabo_manipulation_a64.so ../../loong_sim/module/nabo_manipulation/
    else
        ...
        make -j6 install
        echo ==== 实机aarch64，复制.so到base ===
        cp ../nabo_output/libnabo_manipulation_a64.so ../../loong_base/module/nabo_manipulation/
